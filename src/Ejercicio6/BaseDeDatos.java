...
public class BaseDeDatos {
	public static void main(String[] args) {
		...
		try (Connection connection = DriverManager.getConnection(url);
			...
			String actualizarpib = "UPDATE paises SET pib = pib + 10000000";
			statement.execute(actualizarpib);
			daoPaises.reducir("El Salvador", "Honduras", "Mexico");
			Paises paisEncontrado = daoPaises.buscarPais("Honduras");
